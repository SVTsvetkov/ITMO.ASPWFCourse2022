<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="Lab7.Summary" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            ...
            <tbody>
                ...
                <% var yesData = Lab7.Add_Code.ResponseRepository.GetRepository().GetAllResponses()
